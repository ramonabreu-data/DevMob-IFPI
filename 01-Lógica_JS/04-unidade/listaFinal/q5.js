...
Pedra, Papel, Ataque Aéreo é um jogo infantil muito popular, em que duas ou mais
crianças formam um círculo e fazem gestos com a mão na tentativa de obter a
vitória. As regras são surpreendentemente complexas para um jogo de crianças,
mesmo assim é bastante popular por todo o mundo.
As partidas são muito simples. Os jogadores podem escolher entre o sinal de uma
Pedra (o punho), o sinal de um Papel (a palma aberta), e o sinal para o Ataque Aéreo
(igual ao do Papel, mas com apenas o polegar e o mindinho estendidos).
...
jogador com a Pedra, por razões óbvias.
...
Sua tarefa é escrever um programa que, dada as escolhas de dois jogadores, informe
quem venceu o jogo.
Entrada
...
uma string. A primeira string representa o sinal escolhido pelo jogador 1 e a segunda
string representa o sinal escolhido pelo jogador 2. Essas strings podem ser:
...
function pedraPapelAtaqueAereo (jogador1, jogador2) {
    // Verifica os sinais dos jogadores
    if (jogador1 === "pedra" && jogador2 === "ataque") {
      ...
      throw new Error("Sinais invalidos.");
    }
  }
  ...
  jogador1 = "pedra";
  jogador2 = "ataque";
  console.log(pedraPapelAtaqueAereo(jogador1, jogador2)); // Jogador 1 venceu
